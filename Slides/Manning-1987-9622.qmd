...
: NUMBER OF PERSONS AT ENROLLMENT AND NUMBER OF PERSON-YEARS IN ESTIMATION SAMPLE {.responsive .sm}
...
## Nonparametric Correction in the Error Terms {#sec-error}
...
## Comparison with Selection Models {#sec-selection-models}
...
## Use by Subgroups {.smaller .nonincremental}
...
## Other Subgroups {.smaller .nonincremental}

*Health Status*: No differential response to health insurance coverage observed between healthy and sickly individuals.
Lack of interaction between plan and health status suggests sickly individuals exhibit more discretion at the margin.

*Sites*: No differences in response to insurance coverage among sites.

*Period of Enrollment*: Duration of enrollment does not significantly impact spending or plan responsiveness.

## Other Results {.smaller .nonincremental}

*Dental Results*: Dental services show greater responsiveness to plan in the first year.
